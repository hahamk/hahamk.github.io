...
X=/^(reset|value|show|hide|remove|disable|enable)$/,T=/^(fade|slide|fade&slide)$/,n=[],I=[],F=-1,d=-1,O,U={show:{duration:5},hide:{duration:5,complete:V}};$.fn.fakeselect=function(a,b){!a||$.isPlainObject(a)?W(this,a):"string"==typeof a&&X.test(a)&&this.each(function(){O[a].call(this,b);"reset"!=a&&O.reset.call(this)});return this};O={reset:function(){e.call(this,!0)},value:function(a){this.value=a},show:function(){var a=c(this);$(this).show();l[a]&&(v(a),l[a].show())},hide:function(){var a=c(this);
